...
if(!isset($_POST['fiverr_oid']) || !isset($_POST['fiverr_oemail'])){
    http_response_code(400);
    die('Invalid request');
}

$fiverrOrderId = trim($_POST['fiverr_oid']);
$fiverrEmail = trim($_POST['fiverr_oemail']);
...
// Updating to fiverr table
$stmt=$database->prepare('INSERT INTO `fiverr_data`(`order_id`, `fiverr_id`, `fiverr_email`) VALUES (?,?,?);');
$stmt->bind_param('sss', $orderId, $fiverrOrderId , $fiverrEmail);
$stmt->execute();
$stmt->close();
$database->close();
