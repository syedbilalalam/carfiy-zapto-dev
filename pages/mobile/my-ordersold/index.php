       ...
       <div class="deviceFrameLimitations">
            <div class="container">
                <div class="orders">
                    ...
                    ?>
                    <div class="order">
                        <p class="infoText">Order id: <span class="orderId"><?php echo hash('md5', $order['order_id']); ?></span></p>
                        <hr>
                        <p class="infoText">Order time: <span class="orderTime printTime" data-time="<?php echo $order['time']; ?>">~</span></p>
                        <hr>
                        <p class="infoText">Plan: <span class="orderPlan"><?php echo $planText[$order['plan']]; ?></span></p>
                        <hr>
                        <p class="infoText">Amount: <span class="orderAmount">$<?php echo PRICING[$order['plan']]; ?> USD</span></p>
                        <hr>
                        <p class="infoText">Payment method: <span class="orderMethod"><?php echo ($order['paid']?'Card Payment':'Payment Pending'); ?></span></p>
                        <hr>
                        <p class="infoText clickable">Payment status: <button class="orderReport btn secondary"><?php echo ($order['paid']?'PAID':'Payment PENDING'); ?></button></p>
                        <hr>
                        <p class="infoText">Status:  <span class="orderStatus"><?php echo (($order['delivery_status']>2)?'Delivered via (Email + Web download below)':'Pending ≈ (15 mins to delivery)'); ?> </span></p>
                        <hr>
