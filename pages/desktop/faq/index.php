...
<!-- Local Css file -->
<link rel="stylesheet" href="./static/d/faq/docs/styles.css">
<!-- Pricing css -->
...
<body>
    ...
    <main>
        <div class="deviceFrameLimitations wider">
            <div class="container">
                <section class="sectionC deviceFrameLimitations">
                ...
                <section class="sectionD sectionBlockSystem deviceFrameLimitations">
                    <div class="sectionHeading">
                ...
                <section class="sectionF sectionBlockSystem deviceFrameLimitations">
                    <div class="sectionHeading">
    ...
    <!-- Local js file -->
    <script src="./static/d/faq/docs/scripts.js" type="text/javascript"></script>
</body>
