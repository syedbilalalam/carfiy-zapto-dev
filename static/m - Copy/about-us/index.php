...
<!-- Local Css file -->
<link rel="stylesheet" href="./static/m/about-us/docs/styles.css">
...
<body>
    ...
    <main>
        <?php
            include MAIN_ROOT.'/pages/mobile/commons/mobilenav.php';
        ?>
        <div class="deviceFrameLimitations">
            <div class="container">
                ...
                <img class="aboutusIMG" src="./static/m/about-us/media/vectors/about-us.svg" alt="Image broken">
            </div>
        </div>
    </main>
    <footer>
    ...
    <!-- Local js file -->
    <script src="./static/m/about-us/docs/scripts.js" type="text/javascript"></script>
</body>
