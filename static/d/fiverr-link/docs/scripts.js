...
bankingForm.onsubmit = async (e)=>{
    ...
    formData.append('fiverr_oid', sel('#fiverrOrderId').value);
    formData.append('fiverr_oemail', sel('#fiverrOrderEmail').value);
    ...
    const response = await fetch('workers/apis/get-paid-fiverr.php', {
        method: "POST",
        body: formData
    });
    if(response.ok){
